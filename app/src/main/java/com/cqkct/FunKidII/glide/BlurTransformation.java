...
public class BlurTransformation extends BitmapTransformation {
    ...
    protected Bitmap transform(@NonNull BitmapPool pool, @NonNull Bitmap inBitmap, int outWidth, int outHeight) {
        ...
        Bitmap result = pool.get(scaledWidth, scaledHeight, outConfig);
        ...
        result = fastBlur(result, radius, true);
    ...
    public String toString() {
        return BlurTransformation.class.getSimpleName() + "(radius=" + radius + ", sampling=" + sampling + ")";
    }
