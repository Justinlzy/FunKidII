package com.cqkct.FunKidII.svprogresshub.view;
...
public class SVProgressDefaultView extends LinearLayout {
    ...
    public SVProgressDefaultView(Context context, boolean longText) {
        super(context);
    ...
    private void initViews() {
        LayoutInflater.from(getContext()).inflate(!longText ? R.layout.view_svprogressdefault : R.layout.view_svprogressdefault_long_msg, this, true);
