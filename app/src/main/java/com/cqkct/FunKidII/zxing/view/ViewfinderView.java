...
package com.cqkct.FunKidII.zxing.view;
...
public final class ViewfinderView extends View {
	...
	public ViewfinderView(Context context, AttributeSet attrs) {
		...
		scanLineDrawable = getResources().getDrawable(R.drawable.qr_scan_line);
	}
	...
	public void onDraw(Canvas canvas) {
		...
		if (resultBitmap != null) {
			...
			if (slideTop >= frame.bottom - 9 /* -9 以免扫描线超出方框 */) {
				slideTop = frame.top;
			}

			scanLineRect.left = frame.left;
			scanLineRect.right = frame.right;
			scanLineRect.top = slideTop;
			scanLineRect.bottom = slideTop + 18;
			scanLineDrawable.setBounds(scanLineRect);
