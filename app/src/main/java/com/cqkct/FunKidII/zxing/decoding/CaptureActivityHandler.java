...
package com.cqkct.FunKidII.zxing.decoding;
...
import com.cqkct.FunKidII.zxing.capture.MessageIDs;
import com.cqkct.FunKidII.zxing.view.ViewfinderResultPointCallback;
...
public final class CaptureActivityHandler extends Handler {
  ...
  private final CaptureBindNumberActivity activity;
  ...
  public CaptureActivityHandler(CaptureBindNumberActivity activity, Vector<BarcodeFormat> decodeFormats,
                                String characterSet) {
  ...
  public void handleMessage(Message message) {
    switch (message.what) {
      case MessageIDs.auto_focus:
        //L.d(TAG, "Got auto-focus message");
  ...
  public void quitSynchronously() {
   ...
   //CameraManager.get().stopPreview();
    ...
    // Be absolutely sure we don't sendText any queued up messages
