...
public class CustomDatePicker {
    ...
    private TextView tvCancel, tvOk, hour_text, minute_text;
    ...
    private void initDialog() {
        if (datePickerDialog == null) {
            ...
            TextView title = datePickerDialog.findViewById(R.id.dialog_title);
            title.setText(R.string.babycard_birthday_choice);
    ...
    private void initView() {
        ...
        tvCancel = datePickerDialog.findViewById(R.id.cancel);
        tvOk = datePickerDialog.findViewById(R.id.ok);
