...
public abstract class SupportBlurDialogFragment extends DialogFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (shouldBlur()) {
            ...
            mBlurEngine.setTitleBarHeight(getTitleBarHeight());

            mBlurEngine.setAlwaysBlurStatusBar(shouldAlwaysBlurStatusBar());
        }
     ...
     * For inheritance purpose.
     * <p/>
     * Enable or disable the blur effect on the status bar.
     * <p/>
     * Enabled by default.
     *
     * @return true to enable the blur effect on the status bar.
     */
    protected boolean shouldAlwaysBlurStatusBar() {
        return true;
    }
